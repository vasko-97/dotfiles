...
if [[ -o interactive ]]; then
	PROMPT="${LINE_COLOR}${LINE_UPPER_CORNER}${LINE_STRAIGHT}${LINE_STRAIGHT}${BRACKET_COLOR}[${CLOCK_COLOR}%*${BRACKET_COLOR}]${LINE_COLOR}${LINE_STRAIGHT}${BRACKET_COLOR}[${JOB_COLOR}%j${BRACKET_COLOR}]${LINE_COLOR}${LINE_STRAIGHT}${BRACKET_COLOR}[%m (zsh):${PATH_COLOR}%~${BRACKET_COLOR}]${RESET}
